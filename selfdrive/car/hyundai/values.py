...
class SteerLimitParams: #controls running @ 100hz
  MAX_STEERING_TQ = 8  # Nm (original 12) seems that we need full torque of my SSC assembly
  STEER_DELTA_UP = 5 / 100       # 3 Nm/s (10Nm/s original) start quite low value with i30 because the steering is quite light
